  ...
  <section className="max-w-xl mx-auto py-20 px-6 flex flex-col items-center text-center">
    ...
    <div className="flex flex-col gap-6 w-full items-center mb-10">
      <a
        ...
        className="bg-amber-600 hover:bg-amber-700 text-white font-semibold py-3 px-8 rounded-full shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1 w-full max-w-xs"
      >
        Escribir por WhatsApp
      </a>
      <a
        href={`mailto:${email}`}
        className="text-amber-700 hover:underline text-base"
      >
        {email}
      </a>
    </div>
    <div className="flex justify-center gap-8 mt-4">
      <a
        ...
        className="w-16 h-16 flex items-center justify-center rounded-full bg-white border border-amber-200 shadow transition-all duration-300 hover:bg-amber-100 hover:scale-110 hover:shadow-md"
      >
