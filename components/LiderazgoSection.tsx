    ...
    <div className="relative z-10 w-full max-w-5xl mx-auto px-6">
      ...
      <div className="text-center space-y-5 mb-10 animate-fade-in-hero">
        ...
        <p className="font-sans text-lg text-gray-100 max-w-2xl mx-auto leading-relaxed font-light tracking-[0.01em] drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]">
          Un espacio de formación para desarrollar líderes con carácter, visión y espíritu de servicio.
        </p>
      </div>
      ...
      <div className="bg-black/60 border border-white/10 rounded-2xl p-6 md:p-10 shadow-2xl shadow-black/40 backdrop-blur-sm animate-fade-in-card">
        {/* DESCRIPCIÓN */}
        <p className="font-sans text-gray-100 text-center max-w-2xl mx-auto mb-6 leading-relaxed font-light animate-fade-in-desc">
          La Escuela de Liderazgo está diseñada para formar hombres y mujeres comprometidos con Dios y con las personas, capaces de influir, guiar y servir con integridad.
        </p>
        {/* PROPÓSITO */}
        <p className="font-sans text-gray-100 text-center max-w-2xl mx-auto mb-8 leading-relaxed font-light animate-fade-in-desc" style={{ animationDelay: "150ms" }}>
          A través de principios bíblicos y herramientas prácticas, buscamos desarrollar líderes íntegros con corazón pastoral, entendiendo que el liderazgo verdadero nace del servicio, la responsabilidad y el compromiso.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-cta" style={{ animationDelay: "1400ms" }}>
          ...
          <a
            href="https://wa.me/549123456789?text=Hola!%20Quiero%20info%20sobre%20la%20Escuela%20de%20Liderazgo"
            target="_blank"
            rel="noopener noreferrer"
