...
const SPECS = [
  { out: "home", src: "public/assets/hero-poster.webp" },
...
async function exportOg(inputPath, outName) {
...
async function main() {
  ...
  for (const { out, src } of SPECS) {
    ...
    const { outPath, kb } = await exportOg(input, out);
